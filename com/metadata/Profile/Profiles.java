...
public class Profiles implements Serializable {
    ...
    public Profiles(List<ApplicationVisibilities> applicationVisibilities, List<ClassAccesses> classAccesses, Boolean custom, List<CustomPermissions> customPermissions,
